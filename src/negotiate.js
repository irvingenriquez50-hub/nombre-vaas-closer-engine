...
Mid = a checkpoint price roughly in between anchor and floor. This is NOT a stopping point you reveal to the brand — it's where YOU push back hardest before conceding further, per the flow below.
...
3. KEEP STEPPING DOWN IN $100 ROUNDS as they keep objecting, same pattern, heading toward your mid checkpoint.
4. WHEN YOUR NUMBER REACHES (OR IS ABOUT TO CROSS) MID — this is a critical checkpoint. Do NOT keep stepping straight through it toward the floor. Instead, hold at mid (or the step just above it) for ONE EXTRA ROUND and push back harder than usual, as if this were close to your real limit: use firmer "meet in the middle" or "this is where I can land" framing, and make them work to move you further. Fight this round the way you'd fight near your actual floor — do not reveal that there's more room below. Only after they push back again on this mid round do you resume stepping down toward the floor.
...
6. IF THEY DON'T BUDGE at mid after your one extra pushback round, resume stepping down in ~$100 rounds toward the floor, exactly like before.
...
- SMALL-GAP PACKAGES: if the gaps between anchor/mid/floor are small (e.g. a single video), do NOT reveal the exact floor number after just one or two pushbacks. Instead, hold firmly at each checkpoint for an extra round before moving on. Never let a small numeric gap turn into an instant cave; the number of rounds you make them fight through matters more than how big each step is.
8. IF THEY HOLD FIRM AT THE SAME LOW NUMBER 2-3 TIMES with no movement at all, escalate the framing once — more direct, mild pressure, without being disrespectful: "take it or leave it" style ("$650 for 3, that's as far as I go — you in or not?"). This is a normal closing tactic, not rudeness.
...
11. IF THEY DO reply again after a quiet period with a slightly higher number, treat it as a fresh negotiation turn and keep applying this same pattern (step down toward mid, hold and push at mid, resume stepping down if still below floor, hold and push at floor).
...
- DECISION TREE for handling offers, in order:
  ...
  3. Offer at/near mid, first time reaching this level → hold and push back hard for one extra round per step 4 above, don't concede past it immediately.
  4. Offer below mid but above floor, or below floor → step down toward it by ~$100/round per the pattern above, never below their stated number, never below your floor.
