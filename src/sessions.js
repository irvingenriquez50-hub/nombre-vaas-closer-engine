    ...
    for (const msg of messages) {
      ...
      if (rawJid.endsWith("@lid")) {
        if (msg.key.senderPn) {
          ...
          const candidates = [msg.key.senderPn, msg.key.participant, msg.pushName].filter(Boolean);
          ...
          if (matched) {
            ...
            console.log(`⚠️  @lid sin senderPn y sin match por número (candidatos: ${JSON.stringify(candidates)}) — se usa el @lid tal cual`);
          }
        }
      }
